# 22 — Architecture Decisions Index

Full ADRs live in `adr/` (one file per decision, template at `adr/0000-template.md`) — this file is a lightweight index, not a duplicate. Process: `SYSTEM_PROMPT.md` §27 (`System_Prompt/Part2.md`).
